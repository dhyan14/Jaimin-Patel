...
export default function CombinatoricsContent() {
  return (
    <Layout>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <div className="p-8 text-center bg-purple-50 rounded-lg border-2 border-dashed border-purple-200">
            <h2 className="text-xl font-semibold text-purple-800 mb-3">More Content Coming Soon</h2>
            <p className="text-gray-700">We're preparing comprehensive combinatorics materials for olympiad preparation.</p>
